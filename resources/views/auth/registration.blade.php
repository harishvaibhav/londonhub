...
<div class="flex flex-row w-full items-center h-screen">
    ...
    <div class="w-1/2 p-10 h-screen">
        <div class="flex flex-col justify-center h-screen p-5">
            <div
                class="card-header text-2xl text-center mb-5 bg-gradient-to-r text-white from-cyan-500 to-blue-500 p-2 rounded rounded-xl">
            ...
            <div class="card-body">
                <form action="{{ route('register.post') }}" method="POST">
                    ...
                    <div class="form-group row">
                        <label for="name"
                            class="font-bold text-gray-800 mt-3 col-md-4 col-form-label text-md-right">Name</label>
                        <div class="col-md-6">
                            <input type="text" id="name" class="form-control rounded-lg shadow-lg" name="name" required
                                autofocus>
                            @if ($errors->has('name'))
                    ...
                    <div class="form-group row">
                        <label for="email_address"
                            class="font-bold text-gray-800 mt-3 col-md-4 col-form-label text-md-right">E-Mail
                            Address</label>
                        <div class="col-md-6">
                            <input type="text" id="email_address" class="form-control rounded-lg shadow-lg" name="email"
                                required autofocus>
                            @if ($errors->has('email'))
                    ...
                    <div class="form-group row">
                        <label for="password"
                            class="font-bold text-gray-800 mt-3 col-md-4 col-form-label text-md-right">Password</label>
                        <div class="col-md-6">
                            <input type="password" id="password" class="form-control rounded-lg shadow-lg"
                   ...
                   <div class="text-center mt-10">
                    ...
                    <div class="text-center mt-10">
                        <a href="/login" type="submit" class="inline-block px-6 py-2.5 bg-blue-600 text-white font-medium text-xs leading-tight uppercase rounded shadow-md hover:bg-blue-700 hover:shadow-lg focus:bg-blue-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-blue-800 active:shadow-lg transition duration-150 ease-in-out
